...
const DocModal = ({ isOpen, onClose, pdfUrl, title }) => {
  ...
  // Use Fit instead of FitW to ensure the whole page fits the modal height/width
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4 backdrop-blur-sm bg-black/60">
      {/* Increased max-width to max-4xl for better desktop viewing */}
      <div className="bg-slate-800 w-full max-w-2xl h-[90vh] md:h-[95vh] rounded border border-slate-700 flex flex-col overflow-hidden shadow-2xl">
        {/* Modal Header */}
        <div className="px-5 py-3 border-b border-slate-700 flex justify-between items-center bg-slate-800">
